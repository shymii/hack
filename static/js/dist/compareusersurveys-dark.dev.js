...
function renderComparisionSex(usernameTemplate) {
  fetch('../../sendjsoncompare2').then(function (res) {
    ...
    for (var _i11 = 0; _i11 < users.length; _i11++) {
      ...
      rand2 = Math.floor(255 * Math.random());
      rand3 = Math.floor(255 * Math.random());
      users[_i11]['gradient'] = myChartWeight2.createLinearGradient(0, 0, 0, 400);
    ...
    for (var _i12 = 0; _i12 < users.length; _i12++) {
      ...
      rand2 = Math.floor(255 * Math.random());
      rand3 = Math.floor(255 * Math.random());
      users[_i12]['gradient'] = myChartWeight2.createLinearGradient(0, 0, 0, 400);
    ...
    for (var _i13 = 0; _i13 < users.length; _i13++) {
      ...
      rand2 = Math.floor(255 * Math.random());
      rand3 = Math.floor(255 * Math.random());
      users[_i13]['gradient'] = myChartWeight2.createLinearGradient(0, 0, 0, 400);
    ...
    for (var _i14 = 0; _i14 < users.length; _i14++) {
      ...
      rand2 = Math.floor(255 * Math.random());
      rand3 = Math.floor(255 * Math.random());
      users[_i14]['gradient'] = myChartWeight2.createLinearGradient(0, 0, 0, 400);
    ...
    for (var _i15 = 0; _i15 < users.length; _i15++) {
      ...
      rand2 = Math.floor(255 * Math.random());
      rand3 = Math.floor(255 * Math.random());
      users[_i15]['gradient'] = myChartWeight2.createLinearGradient(0, 0, 0, 400);
    ...
    for (var _i16 = 0; _i16 < users.length; _i16++) {
      ...
      rand2 = Math.floor(255 * Math.random());
      rand3 = Math.floor(255 * Math.random());
      users[_i16]['gradient'] = myChartWeight2.createLinearGradient(0, 0, 0, 400);
    ...
    for (var _i17 = 0; _i17 < users.length; _i17++) {
      ...
      rand2 = Math.floor(255 * Math.random());
      rand3 = Math.floor(255 * Math.random());
      users[_i17]['gradient'] = myChartWeight2.createLinearGradient(0, 0, 0, 400);
    ...
    for (var _i18 = 0; _i18 < users.length; _i18++) {
      ...
      rand2 = Math.floor(255 * Math.random());
      rand3 = Math.floor(255 * Math.random());
      users[_i18]['gradient'] = myChartWeight2.createLinearGradient(0, 0, 0, 400);
